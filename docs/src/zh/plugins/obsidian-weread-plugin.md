...
1. 访问 [GitHub 仓库](https://github.com/zhaohongxuan/obsidian-weread-plugin)
2. 下载最新版本的 Release
3. 解压到 Obsidian 插件目录：`.obsidian/plugins/obsidian-weread-plugin/`
4. 重启 Obsidian
5. 在设置中启用插件

## 基本使用

安装并启用插件后，您可以开始使用 Weread 的各项功能。
...
您可以先访问以下资源：
- [GitHub 仓库](https://github.com/zhaohongxuan/obsidian-weread-plugin) - 查看官方文档
- [咖啡豆社区](/zh/bases/) - 获取更多使用技巧
- [最佳实践](/zh/best-practices/) - 学习社区经验

## 相关插件推荐

以下插件可能与 Weread 配合使用，提升您的 Obsidian 体验：
...
- 在 [GitHub Issues](https://github.com/zhaohongxuan/obsidian-weread-plugin/issues) 提交问题
- 加入咖啡豆社区交流群讨论
