...
1. 访问 [GitHub 仓库](https://github.com/fivol/netwik-obsidian)
2. 下载最新版本的 Release
3. 解压到 Obsidian 插件目录：`.obsidian/plugins/netwik/`
4. 重启 Obsidian
5. 在设置中启用插件

## 基本使用

安装并启用插件后，您可以开始使用 Netwik 的各项功能。
...
您可以先访问以下资源：
- [GitHub 仓库](https://github.com/fivol/netwik-obsidian) - 查看官方文档
- [咖啡豆社区](/zh/bases/) - 获取更多使用技巧
- [最佳实践](/zh/best-practices/) - 学习社区经验

## 相关插件推荐

以下插件可能与 Netwik 配合使用，提升您的 Obsidian 体验：
...
- 在 [GitHub Issues](https://github.com/fivol/netwik-obsidian/issues) 提交问题
- 加入咖啡豆社区交流群讨论
...
**更新内容**：
- 请访问 [GitHub Releases](https://github.com/fivol/netwik-obsidian/releases) 查看详细更新日志

## 致谢

感谢 Boris Bondarenko 开发并维护这个优秀的插件！
