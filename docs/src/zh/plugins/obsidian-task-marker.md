...
2. 搜索并下载「Task Marker」插件
3. 手动安装到 Obsidian 插件目录

### 方法三：GitHub 下载

1. 访问 [GitHub 仓库](https://github.com/wenlzhang/obsidian-task-marker)
2. 下载最新版本的 Release
3. 解压到 Obsidian 插件目录：`.obsidian/plugins/obsidian-task-marker/`
4. 重启 Obsidian
5. 在设置中启用插件

## 基本使用

安装并启用插件后，您可以开始使用 Task Marker 的各项功能。

### 快速开始

1. 打开 Obsidian 设置
2. 找到「Task Marker」插件设置
3. 根据需要配置相关选项
4. 开始使用插件功能
...
您可以先访问以下资源：
- [GitHub 仓库](https://github.com/wenlzhang/obsidian-task-marker) - 查看官方文档
- [咖啡豆社区](/zh/bases/) - 获取更多使用技巧
- [最佳实践](/zh/best-practices/) - 学习社区经验

## 相关插件推荐

以下插件可能与 Task Marker 配合使用，提升您的 Obsidian 体验：
...
- 在 [GitHub Issues](https://github.com/wenlzhang/obsidian-task-marker/issues) 提交问题
- 加入咖啡豆社区交流群讨论
...
**更新内容**：
- 请访问 [GitHub Releases](https://github.com/wenlzhang/obsidian-task-marker/releases) 查看详细更新日志
